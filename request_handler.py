...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_PUT(self):
        ...
        # Find and update a single animal from the list
        if resource == "animals":
